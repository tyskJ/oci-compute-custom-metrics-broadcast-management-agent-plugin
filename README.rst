...
=====================================================================
OCI Compute のカスタムメトリクスを Prometheus Node Exporter (管理エージェント方式) で取得する - Linux/Windows
=====================================================================
* `詳細 <>`_
...
.. code-block:: bash
  ...
  key = "oci-compute-custom-metrics-using-prometheus-node-exporter-by-management-agent/terraform.tfstate"
  auth = "SecurityToken"
